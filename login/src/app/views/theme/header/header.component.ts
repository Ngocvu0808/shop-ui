...
export class HeaderComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		// pages progress bar percentage
		this.router.events.subscribe(event => {
			// if (event instanceof NavigationStart) {
			// 	// set pages progress bar loading to start on NavigationStart event router
			// 	this.loader.start();
			// }
			...
			// 	// set pages progress bar loading to end on NavigationEnd event router
