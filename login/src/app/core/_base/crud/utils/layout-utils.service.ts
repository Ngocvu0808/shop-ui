...
export class LayoutUtilsService {
    ...
    deleteElement(title: string = '', description: string = '', waitDesciption: string = '',
                  btnOK: string = this.translate.instant('COMMON.BTN_CONFIRM'),
                  btnCancel: string = this.translate.instant('COMMON.BTN_CANCEL')) {
        return this.dialog.open(DeleteEntityDialogComponent, {
            data: {title, description, waitDesciption, btnOK, btnCancel},
            width: '440px'
        });
    }
