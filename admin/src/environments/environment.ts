...
export const environment = {
    ...
    API_URL: [app_config.API_URL, app_config.PRODUCT_API_URL, app_config.BUSINESS_API_URL],
    ...
    PRODUCT_DISABLE : '/product/disable/:id',
    PRODUCT_ALL_VALUE : '/product/all-value',
    TRADING_LIST : '/trading',
    GET_BY_ID_IN : '/product/batch',
    TRADING_CHECK_BALANCE : '/trading/check-balance',
    TRADING_REPORT : '/trading/report',
    PRODUCT_BUY : '/trading/buy',
    PRODUCT_SELL : '/trading/sell',
    PRODUCT_GET_LIST_PRODUCT_VALUE: '/product/list-value',

    BUSINESS_GET_LIST_BALANCE: '/business/get-list-balance',
