...
export const environment = {
    ...
    APP_APPROVE_REFRESH_TOKEN: '/auth/app/token/:id/approve',
    APP_UNAPPROVE_REFRESH_TOKEN: '/auth/app/token/:id/un-approve',
    APP_DELETE_REFRESH_TOKEN: '/auth/app/token/:id',
    APP_UPDATE_STATUS_TOKEN: '/auth/app/token/:id/status',
    ...
    APP_GET_AUTH_TYPES: '/auth/app/auth-types',
    APP_CREATE_API_KEY: '/auth/app/:id/api-key',
    APP_GET_ALL_API_KEY: '/auth/app/:id/api-keys',
    APP_CANCEL_API_KEY: '/auth/app/:id/api-key/:apiKey',
    APP_REFRESH_API_KEY: '/auth/app/:id/api-key',
    APP_DELETE_API_KEY: '/auth/app/:id/api-key/:idKey',
    ...
    LOG_HISTORY_EXPORT_FILE: '/auth/app/:id/request-logs/export',
    LOG_HISTORY_DETAIL: '/auth/app/:appId/request-log/:id',
    LOG_HISTORY_REQUEST_STATUS: '/auth/app/request-log/status',
    ...
    SYSTEM_CONFIG_ADD: '/config/system/',
    SYSTEM_CONFIG_GET_ALL: '/config/systems',
    SYSTEM_CONFIG_GET_ALL_KEY: '/config/system/keys',
    SYSTEM_CONFIG_GET_BY_ID: '/config/system/:id',
    SYSTEM_CONFIG_GET_BY_KEY: '/config/system',
    SYSTEM_CONFIG_UPDATE: '/config/system/:id',
    SYSTEM_CONFIG_DELETE: '/config/system/:id',

    FIELD_CONFIG_ADD: '/config/field/',
    FIELD_CONFIG_GET_ALL: '/config/fields',
    FIELD_CONFIG_GET_BY_ID: '/config/field/:id',
    FIELD_CONFIG_GET_TYPE: '/config/field/filters',
    FIELD_CONFIG_GET_TYPE_VALUE: '/config/field/filters',
    FIELD_CONFIG_UPDATE: '/config/field/:id',
    FIELD_CONFIG_DELETE: '/config/field/:id',
    FIELD_CONFIG_GET_BY_TYPE: '/config/field',
    FIELD_OBJECTS: '/config/field/objects',
};
