...
export class SubheaderService {
    ...
    constructor(
        ...
        const initBreadcrumb = () => {
            // get updated title current pages config
            ...
            if (objectPath.get(this.manualTitle, this.router.url)) {
                ...
                if (objectPath.get(this.manualBreadcrumbs, this.router.url)) {
                    ...
                    this.updateBreadcrumbs();
                    // breadcrumbs was appended before, reuse it for this pages
    ...
    updateBreadcrumbs() {
        ...
        if (
            ...
            // and breadcrumb title is same as current pages title
            breadcrumbs[0].title.indexOf(objectPath.get(this.pageConfig, 'pages.title')) !== -1) {
